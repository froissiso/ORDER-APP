...
public class WD_MyBroadcastReceiver extends BroadcastReceiver {
    ...
    private WD_ServerActivity mActivity;
    private List<WifiP2pDevice> mPeers;
    private List<WifiP2pConfig> mConfigs;
    private WifiP2pDevice mDevice;

    public WD_MyBroadcastReceiver(WifiP2pManager manager, WifiP2pManager.Channel channel, WD_ServerActivity activity) {
        super();
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (WifiP2pManager.WIFI_P2P_STATE_CHANGED_ACTION.equals(action)) {
            ...
            if (mManager!=null){
                ...
                PeerListListener mpeerListListener = new PeerListListener() {
                    @Override
    ...
    public void connect(int pos) {
        ...
        config.groupOwnerIntent = 15; //Priority to become the HOST (0-15)
